%% read data
d1 = load('train_unigram.mat');
d2 = load('test_unigram.mat');
data_train = d1.mat;
data_test = d2.mat;
...
for i=-3:1:4
    ...
    for k = -2:1:2;
        ...
        for j =1:5
            ...
            tic;
            svm = svmtrain(train_x,train_y,'kernel_function','rbf','autoscale',false,'boxconstraint',c1,'rbf_sigma',sigma,'kernelcachelimit',16000000,'method','SMO');
            toc;
...
svm = svmtrain(data_train,label_train,'kernel_function','rbf','autoscale',false,'boxconstraint',c_star_vec,'rbf_sigma',sigma_star,'kernelcachelimit',16000000,'method','SMO');
